...
ARRAY['Sigiriya Rock Fortress', 'Dambulla Cave Temple', 'Polonnaruwa Ancient City', 'Kandy Temple'], 
ARRAY['Accommodation', 'All Meals', 'Transport', 'Guide', 'Entrance Fees'],
ARRAY['Day 1: Arrival in Colombo, transfer to Sigiriya', 'Day 2: Sigiriya Rock Fortress climb', 'Day 3: Dambulla Cave Temple & Polonnaruwa', 'Day 4: Travel to Kandy via spice garden', 'Day 5: Temple of Tooth & cultural show', 'Day 6: Kandy city tour & shopping', 'Day 7: Return to Colombo & departure'], true),

('Wildlife & Beach Paradise', '10 Days', '2-12 People', 1299, 1599, 4.8, 203, '/placeholder.svg?height=400&width=600', 'Wildlife', 'Easy',
ARRAY['Yala Safari', 'Whale Watching', 'Mirissa Beach', 'Galle Fort'],
ARRAY['Luxury Hotels', 'All Meals', 'Safari Jeep', 'Boat Tours', 'Guide'],
ARRAY['Day 1-2: Arrival & Yala National Park Safari', 'Day 3-4: Udawalawe Elephant Park', 'Day 5-6: Mirissa whale watching & beach', 'Day 7-8: Galle Fort & southern beaches', 'Day 9-10: Colombo city tour & departure'], false),

('Hill Country Adventure', '5 Days', '2-10 People', 699, 899, 4.7, 89, '/placeholder.svg?height=400&width=600', 'Adventure', 'Moderate',
ARRAY['Ella Nine Arches', 'Tea Plantation Tours', 'Adams Peak Hike', 'Train Journey'],
ARRAY['Mountain Hotels', 'Breakfast', 'Train Tickets', 'Hiking Guide'],
ARRAY['Day 1: Colombo to Nuwara Eliya by train', 'Day 2: Tea plantation tour & factory visit', 'Day 3: Travel to Ella, Nine Arches Bridge', 'Day 4: Adams Peak sunrise hike', 'Day 5: Return journey to Colombo'], false),

('Complete Sri Lanka Experience', '14 Days', '2-20 People', 1899, 2399, 4.9, 312, '/placeholder.svg?height=400&width=600', 'Complete', 'Easy',
ARRAY['All Major Attractions', 'Cultural Sites', 'Wildlife Safari', 'Beach Time'],
ARRAY['Premium Hotels', 'All Meals', 'Private Transport', 'Expert Guide', 'All Activities'],
ARRAY['Day 1-3: Cultural Triangle (Sigiriya, Dambulla, Polonnaruwa)', 'Day 4-6: Kandy & hill country', 'Day 7-9: Wildlife safaris (Yala & Udawalawe)', 'Day 10-12: Southern beaches & Galle', 'Day 13-14: Colombo & departure'], true),

('Luxury Honeymoon Package', '6 Days', '2 People', 1799, 2199, 4.9, 89, '/placeholder.svg?height=400&width=600', 'Luxury', 'Easy',
ARRAY['Luxury Resorts', 'Private Dinners', 'Spa Treatments', 'Romantic Excursions'],
ARRAY['5-Star Hotels', 'Private Transport', 'Candlelit Dinners', 'Couple Spa'],
ARRAY['Day 1-2: Luxury resort in Kandy', 'Day 3-4: Hill country luxury stay', 'Day 5-6: Beach resort with spa'], true)
ON CONFLICT DO NOTHING;
...
('Whale Watching in Mirissa', 'Mirissa, Southern Coast', 'Marine', '3-4 hours', 45, 4.8, 234, '/placeholder.svg?height=400&width=600', true, 'Experience the thrill of spotting blue whales, sperm whales, and dolphins in their natural habitat', ARRAY['Blue whale sightings', 'Dolphin encounters', 'Professional guides', 'Safety equipment provided'], 'November to April', 'Easy', 'Up to 30 people'),

('Surfing in Arugam Bay', 'Arugam Bay, Eastern Coast', 'Water Sports', '2-3 hours', 35, 4.9, 189, '/placeholder.svg?height=400&width=600', true, 'Ride world-class waves at one of Asia''s top surfing destinations', ARRAY['Professional instruction', 'Board rental included', 'All skill levels', 'Perfect waves'], 'May to September', 'Beginner to Advanced', 'Up to 8 people'),

('Tea Plantation Trekking', 'Ella, Hill Country', 'Trekking', '4-5 hours', 25, 4.7, 156, '/placeholder.svg?height=400&width=600', false, 'Hike through emerald tea plantations and learn about Ceylon tea production', ARRAY['Tea factory visit', 'Scenic mountain views', 'Local guide', 'Tea tasting session'], 'Year round', 'Moderate', 'Up to 12 people'),

('Wildlife Safari in Yala', 'Yala National Park', 'Wildlife', '6-8 hours', 65, 4.8, 298, '/placeholder.svg?height=400&width=600', true, 'Spot leopards, elephants, and exotic birds in Sri Lanka''s premier national park', ARRAY['Leopard spotting', 'Elephant herds', 'Bird watching', 'Professional safari guide'], 'February to July', 'Easy', 'Up to 6 people'),

('Rock Climbing at Sigiriya', 'Sigiriya, Central Province', 'Adventure', '3-4 hours', 40, 4.6, 87, '/placeholder.svg?height=400&width=600', false, 'Climb the ancient rock fortress and explore 5th-century frescoes', ARRAY['Ancient frescoes', 'Summit views', 'Historical significance', 'Photography opportunities'], 'Early morning', 'Moderate', 'Up to 15 people'),

('White Water Rafting', 'Kitulgala', 'Adventure', '4-5 hours', 55, 4.7, 134, '/placeholder.svg?height=400&width=600', true, 'Navigate thrilling rapids through lush rainforest landscapes', ARRAY['Grade 2-3 rapids', 'Safety equipment', 'Experienced guides', 'Scenic river journey'], 'May to December', 'Moderate', 'Up to 8 people'),

('Hot Air Ballooning', 'Dambulla, Central Province', 'Aerial', '3-4 hours', 180, 4.9, 67, '/placeholder.svg?height=400&width=600', false, 'Soar above ancient temples and lush landscapes at sunrise', ARRAY['Sunrise flight', 'Aerial photography', 'Champagne breakfast', 'Certificate of flight'], 'Year round', 'Easy', 'Up to 4 people'),

('Scuba Diving in Hikkaduwa', 'Hikkaduwa, Western Coast', 'Marine', '4-5 hours', 75, 4.8, 145, '/placeholder.svg?height=400&width=600', true, 'Explore vibrant coral reefs and diverse marine life', ARRAY['Coral reef exploration', 'Tropical fish', 'Professional instruction', 'Equipment included'], 'November to April', 'Beginner to Advanced', 'Up to 6 people')
ON CONFLICT DO NOTHING;
